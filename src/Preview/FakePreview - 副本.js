            ...
            setters : [
                {
                    ...
                    content: "<h1 style='text-align:center;'>hello world</h1>"
                },
                {
                    index: 1,
                    width: 500,
                ...
                },
                {
                    ...
                    x: 150,
                    y: 400,
                    color: "rgba(0,77,6,0.5)",
                    content: "<h2>2020.10.7</h2>"
                },
                {
                    index: 3,
                    width: 600,
                ...
                },
                {
                    ...
                    x: 200,
                    y: 100,
                    color: "rgba(5,255,44,1)",
                    content: "<h4 style='text-align:center;'>Nice to meet you!</h4>"
                }
            ],
            wrate : (1500/1024)
        }
